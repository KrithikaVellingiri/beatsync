...
export default function Layout() {
  const { theme, fetchDistributorInfo, fetchTeam } = useBeatSyncStore();
  ...
  useEffect(() => {
    // Fetch authenticated distributor info and delivery team on mount
  ...
  return (
    <div className={theme === "dark" ? "dark" : ""}>
      <div className="app-shell min-h-screen flex">
        ...
        {askOpen && <AskBeatSyncAI onClose={() => setAskOpen(false)} />}
