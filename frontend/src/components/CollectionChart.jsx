...
export default function CollectionChart() {
  return <div className="glass rounded-3xl p-5">
    <div className="flex items-center justify-between mb-5"><div><h3 className="font-bold">Collection Trend</h3><p className="text-xs text-slate-500 mt-1">Cash collected across recent days</p></div><span className="pill px-3 py-1.5 bg-blue-50 text-blue-700 dark:bg-blue-950/40 dark:text-blue-300 text-xs font-semibold">7 days</span></div>
    <div className="h-64">
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={collectionTrend} margin={{left: -15,right: 5,top: 5,bottom: 0}}>
